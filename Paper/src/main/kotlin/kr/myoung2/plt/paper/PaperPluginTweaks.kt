...
class PaperPluginTweaks : JavaPlugin() {
    ...
    fun registerRecipes() {
        ...
        val saddle = ShapedRecipe(NamespacedKey(this,"saddle"), ItemStack(Material.SADDLE))
            .shape("lll","ldl","   ").setIngredient('l',Material.LEATHER).setIngredient('d',Material.LEAD)
        ...
        val elytra = ShapedRecipe(NamespacedKey(this,"elytra"), ItemStack(Material.ELYTRA))
            .shape("sbs","sps","s s").setIngredient('p',Material.PHANTOM_MEMBRANE)
            .setIngredient('s', Material.SHULKER_SHELL).setIngredient('b',Material.DRAGON_BREATH)
        ...
        val spider_web = ShapelessRecipe(NamespacedKey(this,"spider_web"), ItemStack(Material.COBWEB,4))
            .addIngredient(8,Material.STRING)
        val sponge = ShapedRecipe(NamespacedKey(this,"sponge"), ItemStack(Material.SPONGE,4)).shape("www","wmw","www")
